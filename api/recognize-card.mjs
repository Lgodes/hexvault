...
async function scryfall(path){const response=await fetch('https://api.scryfall.com'+path,{headers:{Accept:'application/json;q=0.9,*/*;q=0.8','User-Agent':'HexVault/173 card recognition'}});if(!response.ok)return null;return response.json()}
